...
<svg {{ $attributes->class(['size-5 shrink-0']) }} viewBox="0 0 24 24" fill="{{ $filled ? 'currentColor' : 'none' }}" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
    @switch($name)
        ...
        @case('star') <path d="M11.3 2.9a.76.76 0 0 1 1.4 0l2.35 5.13 5.6.65a.76.76 0 0 1 .44 1.3l-4.15 3.82 1.12 5.53a.76.76 0 0 1-1.14.83L12 17.38l-4.92 2.78a.76.76 0 0 1-1.14-.83l1.12-5.53-4.15-3.82a.76.76 0 0 1 .44-1.3l5.6-.65Z"/> @break
